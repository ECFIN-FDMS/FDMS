...
class TestCountryCalculations(unittest.TestCase):
    ...
    def comparator(self, expected_df, expected_vars, result, filename):
    ...
    def test_country_calculation_BE(self):
        ...
        differences1, wrong_vars1, additional_vars1 = self.comparator(expected_df, expected_vars, result, filename)
